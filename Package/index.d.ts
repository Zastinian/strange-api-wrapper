declare class StrangeApi {
  ...
  gruPlan(data: {first_step: string; second_step: string; third_step: string; fourth_step: string}): ArrayBuffer;
  ...
  planktonPlan(data: {first_step: string; second_step: string; third_step: string; fourth_step: string}): ArrayBuffer;
  ...
  farewellCard(data: {avatar: string; name: string; discriminator: string; count: number; guild: string; bkg: string}): ArrayBuffer;
  rankCard(data: {
    avatar: string;
    currentxp: number;
    reqxp: number;
  ...
  spotifyCard(data: {image: string; author: string; album: string; start: number; end: number; title: string}): ArrayBuffer;
  welcomeCard(data: {avatar: string; name: string; discriminator: string; count: number; guild: string; bkg: string}): ArrayBuffer;
}
